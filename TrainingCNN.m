...
for test = 1:3
     % input filename
     filename_dataset = strcat('/space1/maria+nolan/FeatureExtractionDatasets/N14_Min100_Max1800_Q3.mat');
     ...
     trainedNetwork = strcat('/space1/maria+nolan/FeatureExtractionDatasets/TrainedNetworks/N14_Min100_Max1800_Q3_TrainedNetwork', num2str(test), '.mat');
