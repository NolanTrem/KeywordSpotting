%% Trains the architechture while varying the number of filters
...
for n = 2:2:32
    ...
    trainedNetwork = strcat('/space1/maria+nolan/FeatureExtractionDatasets/N', string(n), '_Min100_Max_Q3_Network.mat');
