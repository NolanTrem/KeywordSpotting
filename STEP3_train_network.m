...
% input filename
filename_dataset = 'datasets/model_output/dataset_model_6bits.mat';

% output filename
filename_trained_network = 'trained_networks/net_model_6bits.mat';
...
net_trained = trainNetwork(x_train,y_train,lgraph,options);



%% save the trained network

save(filename_trained_network,'net_trained');
